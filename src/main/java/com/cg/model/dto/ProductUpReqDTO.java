...
public class ProductUpReqDTO implements Validator {
    ...
    private CategoryUpReqDTO categoryUpReqDTO;
    ...
    public Product toProduct(Long productId) {
        return new Product()
                ...
                .setCategory(categoryUpReqDTO.toCategory())
    ...
    public void validate(Object o, Errors errors) {
        ...
        ProductUpReqDTO productUpReqDTO = (ProductUpReqDTO) o;

        String productName = productUpReqDTO.productName;

        String price = productUpReqDTO.price;
